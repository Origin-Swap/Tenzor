  ...
  return (
    <section className="relative md:px-14 pt-24 pb-20 lg:pt-28 lg:pb-32 overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-14 gap-10 items-center">
          ...
          <div className="text-center lg:text-left order-1">
            ...
            <div className="hidden lg:block max-w-md mx-auto lg:mx-0">
              <div className="flex flex-col font-bold sm:flex-row gap-4">
                ...
                {/* Primary */}
                <a
                  href="https://app.tenzorassets.com"
                  className="group relative flex items-center justify-center gap-2 px-7 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-500 text-white font-bold shadow-lg shadow-indigo-600/30 transition-all hover:scale-[1.02] hover:shadow-indigo-500/50 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                >
                  Start Tokenization
          ...
          <div className="order-3 lg:hidden max-w-md mx-auto w-full">
            <div className="flex flex-col gap-4">
              ...
              <a
                href="https://app.tenzorassets.com"
                className="group flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-500 text-white font-bold shadow-lg shadow-indigo-600/30 transition-all hover:scale-[1.02]"
              >
                Start Tokenization
                <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
              </a>
              ...
              <a
                href="https://docs.tenzorassets.com"
                className="flex items-center justify-center px-6 py-4 rounded-xl border border-slate-700 text-slate-300 hover:border-indigo-500/50 hover:text-white transition-all"
              >
                Read Docs
              </a>
